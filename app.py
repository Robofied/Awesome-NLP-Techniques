# --------------------------#
# Author :  Mansi Maurya
# Github : https://github.com/mansi75
# Repository : https://github.com/Robofied/Awesome-NLP-Techniques
# --------------------------#
...
def main():
    ...
    display = ["Home", "Tokenization", "Stemming",
        "Stopwords", "Lemmatization", "BagOfWords", "PosTagging"]
